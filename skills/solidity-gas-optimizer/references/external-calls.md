...
- **Savings**: each eliminated hop saves the CALL cost (2600 cold / 100 warm), ABI encoding/decoding, calldata copying, and the fresh execution context; internal function calls are near-free JUMPs.
