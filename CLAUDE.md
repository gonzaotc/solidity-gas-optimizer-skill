...
5. `SOURCES.md` is an optional attribution and coverage aid: keep it in sync when you choose to use it, and keep retired IDs recorded there so they are never reassigned.
